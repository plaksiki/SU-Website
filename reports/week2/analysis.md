...
- Assumed quick links would be useful - customer confirmed they are not needed
- Assumed an internships section would be valuable - customer rejected it
- Assumed anonymous feedback might be controversial - customer approved it
- Assumed one design fits all departments - customer prefers department switching on a single main page
- Assumed the stats/numbers section (member count, etc.) was not needed - customer approved it and liked it
- Assumed "Get Involved" section would be useful - customer confirmed it is not needed and should not be added
